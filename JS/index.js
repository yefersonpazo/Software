...
document.querySelectorAll('[data-next]').forEach((button) => button.addEventListener('click', () => showSlide(activeIndex + 1)));
...
if (window.gsap) {
	gsap.to('#wave-front', { duration: 7, attr: { d: 'M0,105 C250,175 470,20 730,125 C990,205 1170,25 1440,92 L1440,190 L0,190 Z' }, repeat: -1, yoyo: true, ease: 'sine.inOut' });
	gsap.to('#wave-back', { duration: 9, attr: { d: 'M0,105 C250,15 460,180 720,68 C980,10 1170,160 1440,85 L1440,190 L0,190 Z' }, repeat: -1, yoyo: true, ease: 'sine.inOut', delay: .7 });
}
